...
// Very nice problem, with a relatively straight forward solution
...
public:
    ...
    void inc(string key) {
        ...
        auto next = bucketOfKey[key], bucket = next++; // assign current to bucket, and increment next to become next
    ...
    void dec(string key) {
        ...
        auto prev = bucketOfKey[key], bucket = prev--; // assign current to bucket, and decrement prev to become prev
